...
function peg$parse(input, options) {
  ...
  var peg$c11 = function(expression) {
        return {
          type: "labeled",
          label: "value",
          expression: expression,
  ...
  var peg$c12 = function(head, extract, tail) {
        return {
          type: "action",
          expression: {
            type: "sequence",
  ...
  var peg$c13 = function(head, tail) {
        return tail.length > 0
          ? {
              type: "sequence",
  ...
  var peg$c17 = function(operator, expression) {
        return {
  ...
  function peg$parseExtractExpression() {
    var s0, s1, s2, s3;
  ...
  function peg$parseExtractSequenceExpression() {
    var s0, s1, s2, s3, s4, s5, s6, s7;
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      if (s2 !== peg$FAILED) {
        s3 = peg$parseExtractExpression();
        if (s3 !== peg$FAILED) {
          s4 = [];
          s5 = peg$currPos;
          s6 = peg$parse__();
          if (s6 !== peg$FAILED) {
            s7 = peg$parsePrefixedExpression();
            if (s7 !== peg$FAILED) {
              s6 = [s6, s7];
              s5 = s6;
            } else {
  ...
  function peg$parseSequenceExpression() {
    ...
    s0 = peg$parseExtractSequenceExpression();
    if (s0 === peg$FAILED) {
      s0 = peg$currPos;
